...
#
# Usage:
#   bash collab_UAV_UGV/scripts/auto_run_collab.sh [N] [EPISODE_ID]
#
# Flow per run:
...
SCRIPTS="$DIR/collab_UAV_UGV/scripts"
TEMPLATES="$DIR/collab_UAV_UGV/episodes/town10hd_templates.json"
RUNS="$DIR/collab_UAV_UGV/runs"
...
echo "============================================"
echo "  Collab UAV+UGV Auto-Run: $N runs on $EP"
